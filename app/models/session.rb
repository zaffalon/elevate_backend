class Session < ApplicationRecord
  ...
  def create_jwt(payload = {}, secret=Rails.application.credentials.secret_key_base)
    # User attributes
    payload[:user] = {}
  ...
  def decode_jwt(token = self.token, secret=Rails.application.credentials.secret_key_base, verify=true)
